...
const TRIVIA_QUESTIONS_BY_DIFFICULTY = {
  ...
  'easy': [
    ...
    { id: 'E21', category: 'Movies', question: 'In "Cars", what type of vehicle is Lightning McQueen?', answers: ['Race car', 'Truck', 'Bus', 'Helicopter', 'Motorcycle', 'Taxi'], correctIndex: 0 },
    { id: 'E22', category: 'Movies', question: 'In "Inside Out", what color is Sadness?', answers: ['Blue', 'Yellow', 'Red', 'Green', 'Purple', 'Orange'], correctIndex: 0 },
    { id: 'E23', category: 'Movies', question: 'In "Kung Fu Panda", what animal is Po?', answers: ['Panda', 'Tiger', 'Snake', 'Crane', 'Monkey', 'Mantis'], correctIndex: 0 },
    { id: 'E24', category: 'Movies', question: 'What superhero lives in Gotham City?', answers: ['Batman', 'Superman', 'Spider-Man', 'Iron Man', 'Flash', 'Aquaman'], correctIndex: 0 },
    { id: 'E25', category: 'Movies', question: 'What is the name of Shrek\'s wife?', answers: ['Fiona', 'Cinderella', 'Ariel', 'Belle', 'Aurora', 'Jasmine'], correctIndex: 0 },
    { id: 'E26', category: 'TV Shows', question: 'In "Phineas and Ferb", what is their pet platypus named?', answers: ['Perry', 'Paul', 'Pete', 'Plato', 'Phil', 'Patrick'], correctIndex: 0 },
    { id: 'E27', category: 'TV Shows', question: 'What color is Clifford the Big Red Dog?', answers: ['Red', 'Blue', 'Yellow', 'Green', 'Brown', 'Orange'], correctIndex: 0 },
    { id: 'E28', category: 'TV Shows', question: 'What is the name of the talking dog in Scooby-Doo?', answers: ['Scooby-Doo', 'Shaggy', 'Velma', 'Fred', 'Daphne', 'Scrappy'], correctIndex: 0 },
    { id: 'E29', category: 'Video Games', question: 'What game features catching creatures called Pokemon?', answers: ['Pokemon', 'Mario', 'Zelda', 'Sonic', 'Kirby', 'Metroid'], correctIndex: 0 },
    { id: 'E30', category: 'Video Games', question: 'In "Angry Birds", what do you launch at pigs?', answers: ['Birds', 'Balls', 'Rocks', 'Eggs', 'Bombs', 'Stars'], correctIndex: 0 },
    { id: 'E31', category: 'Video Games', question: 'What yellow character eats dots and avoids ghosts?', answers: ['Pac-Man', 'Pikachu', 'Sonic', 'Mario', 'Kirby', 'SpongeBob'], correctIndex: 0 },
    { id: 'E32', category: 'Animals', question: 'What is the tallest animal in the world?', answers: ['Giraffe', 'Elephant', 'Horse', 'Camel', 'Ostrich', 'Bear'], correctIndex: 0 },
    { id: 'E33', category: 'Animals', question: 'What animal has black and white fur and eats bamboo?', answers: ['Panda', 'Zebra', 'Penguin', 'Skunk', 'Badger', 'Lemur'], correctIndex: 0 },
    { id: 'E34', category: 'Animals', question: 'What is a group of fish called?', answers: ['School', 'Herd', 'Pack', 'Flock', 'Swarm', 'Colony'], correctIndex: 0 },
    { id: 'E35', category: 'Animals', question: 'What sea animal has eight arms?', answers: ['Octopus', 'Starfish', 'Jellyfish', 'Crab', 'Squid', 'Lobster'], correctIndex: 0 },
    { id: 'E36', category: 'Sports', question: 'What sport uses a racket and a shuttlecock?', answers: ['Badminton', 'Tennis', 'Squash', 'Ping Pong', 'Racquetball', 'Volleyball'], correctIndex: 0 },
    { id: 'E37', category: 'Sports', question: 'In what sport do you try to get a hole in one?', answers: ['Golf', 'Bowling', 'Basketball', 'Soccer', 'Hockey', 'Pool'], correctIndex: 0 },
    { id: 'E38', category: 'Sports', question: 'How many players are on a basketball team on the court?', answers: ['5', '6', '7', '11', '4', '8'], correctIndex: 0 },
    { id: 'E39', category: 'Science', question: 'What planet is known for having rings?', answers: ['Saturn', 'Mars', 'Venus', 'Mercury', 'Jupiter', 'Neptune'], correctIndex: 0 },
    { id: 'E40', category: 'Science', question: 'What is the name of our galaxy?', answers: ['Milky Way', 'Andromeda', 'Spiral', 'Solar', 'Cosmic', 'Starlight'], correctIndex: 0 },
    { id: 'E41', category: 'Science', question: 'What makes a rainbow appear?', answers: ['Sunlight and rain', 'Wind', 'Clouds', 'Snow', 'Lightning', 'Fog'], correctIndex: 0 },
    { id: 'E42', category: 'General', question: 'What holiday do people dress up in costumes?', answers: ['Halloween', 'Christmas', 'Easter', 'Thanksgiving', 'Valentine\'s Day', 'New Year\'s'], correctIndex: 0 },
    { id: 'E43', category: 'General', question: 'What imaginary creature breathes fire?', answers: ['Dragon', 'Unicorn', 'Mermaid', 'Giant', 'Fairy', 'Phoenix'], correctIndex: 0 },
    { id: 'E44', category: 'History', question: 'What did the ancient Egyptians build for their kings?', answers: ['Pyramids', 'Castles', 'Churches', 'Bridges', 'Temples', 'Palaces'], correctIndex: 0 },
    { id: 'E45', category: 'History', question: 'What famous ship hit an iceberg and sank?', answers: ['Titanic', 'Mayflower', 'Santa Maria', 'Queen Mary', 'Lusitania', 'Olympic'], correctIndex: 0 },
    { id: 'E46', category: 'Geography', question: 'What is the largest continent?', answers: ['Asia', 'Africa', 'North America', 'Europe', 'South America', 'Australia'], correctIndex: 0 },
    { id: 'E47', category: 'Geography', question: 'What ocean is between America and Europe?', answers: ['Atlantic', 'Pacific', 'Indian', 'Arctic', 'Southern', 'Caribbean'], correctIndex: 0 },
    { id: 'E48', category: 'Geography', question: 'In what country is the Great Wall?', answers: ['China', 'Japan', 'India', 'Korea', 'Vietnam', 'Mongolia'], correctIndex: 0 },
    { id: 'E49', category: 'Movies', question: 'In "Zootopia", what kind of animal is Judy Hopps?', answers: ['Rabbit', 'Fox', 'Lion', 'Elephant', 'Sloth', 'Sheep'], correctIndex: 0 },
    { id: 'E50', category: 'General', question: 'What do you blow out on a birthday cake?', answers: ['Candles', 'Balloons', 'Confetti', 'Streamers', 'Sparklers', 'Ribbons'], correctIndex: 0 }
  ],
  'medium': [
    ...
    { id: 'M21', category: 'Movies', question: 'In "The Hunger Games", what is the name of the main character?', answers: ['Katniss', 'Tris', 'Hermione', 'Bella', 'Clary', 'Eleven'], correctIndex: 0 },
    { id: 'M22', category: 'Movies', question: 'In "Avatar", what color are the Na\'vi people?', answers: ['Blue', 'Green', 'Purple', 'Red', 'Orange', 'Pink'], correctIndex: 0 },
    { id: 'M23', category: 'Movies', question: 'What wizard school does Harry Potter attend?', answers: ['Hogwarts', 'Beauxbatons', 'Durmstrang', 'Ilvermorny', 'Castelobruxo', 'Mahoutokoro'], correctIndex: 0 },
    { id: 'M24', category: 'Movies', question: 'In "Guardians of the Galaxy", what is Rocket?', answers: ['Raccoon', 'Fox', 'Squirrel', 'Possum', 'Ferret', 'Badger'], correctIndex: 0 },
    { id: 'M25', category: 'TV Shows', question: 'In "Breaking Bad", what subject does Walter White teach?', answers: ['Chemistry', 'Math', 'Physics', 'Biology', 'English', 'History'], correctIndex: 0 },
    { id: 'M26', category: 'TV Shows', question: 'In "The Mandalorian", what is Din Djarin\'s ship called?', answers: ['Razor Crest', 'Millennium Falcon', 'Ghost', 'Slave I', 'X-Wing', 'TIE Fighter'], correctIndex: 0 },
    { id: 'M27', category: 'Music', question: 'What pop star is known as the "Material Girl"?', answers: ['Madonna', 'Cyndi Lauper', 'Whitney Houston', 'Janet Jackson', 'Cher', 'Tina Turner'], correctIndex: 0 },
    { id: 'M28', category: 'Music', question: 'What artist released "Shape of You"?', answers: ['Ed Sheeran', 'Justin Bieber', 'Bruno Mars', 'The Weeknd', 'Shawn Mendes', 'Charlie Puth'], correctIndex: 0 },
    { id: 'M29', category: 'Music', question: 'What artist is known for "Uptown Funk"?', answers: ['Bruno Mars', 'Drake', 'Kanye West', 'Post Malone', 'The Weeknd', 'Pharrell'], correctIndex: 0 },
    { id: 'M30', category: 'Video Games', question: 'In "League of Legends", how many players are on each team?', answers: ['5', '6', '4', '3', '7', '8'], correctIndex: 0 },
    { id: 'M31', category: 'Video Games', question: 'In "Valorant", what are the playable characters called?', answers: ['Agents', 'Legends', 'Champions', 'Heroes', 'Operators', 'Specialists'], correctIndex: 0 },
    { id: 'M32', category: 'Video Games', question: 'In "Overwatch", what role does Mercy play?', answers: ['Support', 'Tank', 'Damage', 'Defense', 'Healer', 'Assault'], correctIndex: 0 },
    { id: 'M33', category: 'Science', question: 'What is the chemical formula for table salt?', answers: ['NaCl', 'H2O', 'CO2', 'O2', 'NaOH', 'HCl'], correctIndex: 0 },
    { id: 'M34', category: 'Science', question: 'What planet is closest to the Sun?', answers: ['Mercury', 'Venus', 'Mars', 'Earth', 'Jupiter', 'Saturn'], correctIndex: 0 },
    { id: 'M35', category: 'Science', question: 'What is the largest organ in the human body?', answers: ['Skin', 'Liver', 'Brain', 'Heart', 'Lungs', 'Intestines'], correctIndex: 0 },
    { id: 'M36', category: 'Sports', question: 'How many innings are in a standard baseball game?', answers: ['9', '7', '10', '8', '6', '11'], correctIndex: 0 },
    { id: 'M37', category: 'Sports', question: 'How many points is a three-pointer worth in basketball?', answers: ['3', '2', '4', '1', '5', '6'], correctIndex: 0 },
    { id: 'M38', category: 'Sports', question: 'What is the highest score possible in bowling?', answers: ['300', '200', '400', '250', '350', '150'], correctIndex: 0 },
    { id: 'M39', category: 'General', question: 'What is the capital of France?', answers: ['Paris', 'London', 'Berlin', 'Rome', 'Madrid', 'Vienna'], correctIndex: 0 },
    { id: 'M40', category: 'General', question: 'How many states are in the United States?', answers: ['50', '48', '52', '45', '51', '49'], correctIndex: 0 },
    { id: 'M41', category: 'General', question: 'What is the currency used in Japan?', answers: ['Yen', 'Won', 'Yuan', 'Dollar', 'Peso', 'Rupee'], correctIndex: 0 },
    { id: 'M42', category: 'History', question: 'Who was the first man to walk on the moon?', answers: ['Neil Armstrong', 'Buzz Aldrin', 'Yuri Gagarin', 'John Glenn', 'Alan Shepard', 'Michael Collins'], correctIndex: 0 },
    { id: 'M43', category: 'History', question: 'What year did World War II begin?', answers: ['1939', '1941', '1937', '1945', '1938', '1940'], correctIndex: 0 },
    { id: 'M44', category: 'History', question: 'Who painted the Mona Lisa?', answers: ['Leonardo da Vinci', 'Michelangelo', 'Raphael', 'Rembrandt', 'Botticelli', 'Caravaggio'], correctIndex: 0 },
    { id: 'M45', category: 'Geography', question: 'What is the largest desert in the world?', answers: ['Antarctic Desert', 'Sahara', 'Arabian', 'Gobi', 'Kalahari', 'Mojave'], correctIndex: 0 },
    { id: 'M46', category: 'Geography', question: 'What river flows through London?', answers: ['Thames', 'Seine', 'Danube', 'Rhine', 'Tiber', 'Po'], correctIndex: 0 },
    { id: 'M47', category: 'Technology', question: 'What company makes the iPhone?', answers: ['Apple', 'Samsung', 'Google', 'Microsoft', 'Sony', 'LG'], correctIndex: 0 },
    { id: 'M48', category: 'Technology', question: 'What company created the PlayStation?', answers: ['Sony', 'Microsoft', 'Nintendo', 'Sega', 'Atari', 'Panasonic'], correctIndex: 0 },
    { id: 'M49', category: 'Technology', question: 'What AI chatbot was released by OpenAI in 2022?', answers: ['ChatGPT', 'Siri', 'Alexa', 'Cortana', 'Bard', 'Claude'], correctIndex: 0 },
    { id: 'M50', category: 'Music', question: 'Which K-pop girl group performed "Kill This Love"?', answers: ['BLACKPINK', 'TWICE', 'Red Velvet', 'ITZY', 'aespa', 'NewJeans'], correctIndex: 0 }
  ],
  'hard': [
    ...
    { id: 'H21', category: 'History', question: 'Who was the leader of Nazi Germany?', answers: ['Adolf Hitler', 'Joseph Stalin', 'Benito Mussolini', 'Winston Churchill', 'Charles de Gaulle', 'Franklin Roosevelt'], correctIndex: 0 },
    { id: 'H22', category: 'History', question: 'Which empire was ruled by Julius Caesar?', answers: ['Roman Empire', 'Greek Empire', 'Persian Empire', 'Ottoman Empire', 'Byzantine Empire', 'Mongol Empire'], correctIndex: 0 },
    { id: 'H23', category: 'History', question: 'What was the name of the ship that brought the Pilgrims to America?', answers: ['Mayflower', 'Santa Maria', 'Pinta', 'Victoria', 'Endeavour', 'Golden Hind'], correctIndex: 0 },
    { id: 'H24', category: 'History', question: 'Who was the first female pilot to fly solo across the Atlantic?', answers: ['Amelia Earhart', 'Harriet Quimby', 'Bessie Coleman', 'Jacqueline Cochran', 'Beryl Markham', 'Amy Johnson'], correctIndex: 0 },
    { id: 'H25', category: 'History', question: 'What ancient civilization built Machu Picchu?', answers: ['Inca', 'Aztec', 'Maya', 'Olmec', 'Nazca', 'Toltec'], correctIndex: 0 },
    { id: 'H26', category: 'Science', question: 'What is the chemical symbol for potassium?', answers: ['K', 'Po', 'Pt', 'P', 'Pa', 'Pu'], correctIndex: 0 },
    { id: 'H27', category: 'Science', question: 'What type of bond is formed when atoms share electrons?', answers: ['Covalent', 'Ionic', 'Metallic', 'Hydrogen', 'Van der Waals', 'Dipole'], correctIndex: 0 },
    { id: 'H28', category: 'Science', question: 'What is the largest bone in the human body?', answers: ['Femur', 'Tibia', 'Humerus', 'Spine', 'Pelvis', 'Fibula'], correctIndex: 0 },
    { id: 'H29', category: 'Science', question: 'What is the SI unit of electric current?', answers: ['Ampere', 'Volt', 'Watt', 'Ohm', 'Coulomb', 'Joule'], correctIndex: 0 },
    { id: 'H30', category: 'Science', question: 'What planet is known as the "Morning Star"?', answers: ['Venus', 'Mars', 'Mercury', 'Jupiter', 'Saturn', 'Neptune'], correctIndex: 0 },
    { id: 'H31', category: 'Geography', question: 'What is the capital of Brazil?', answers: ['Brasilia', 'Rio de Janeiro', 'Sao Paulo', 'Salvador', 'Recife', 'Fortaleza'], correctIndex: 0 },
    { id: 'H32', category: 'Geography', question: 'Which country has the most natural lakes?', answers: ['Canada', 'United States', 'Russia', 'Finland', 'Sweden', 'Norway'], correctIndex: 0 },
    { id: 'H33', category: 'Geography', question: 'What country is home to the Great Barrier Reef?', answers: ['Australia', 'Indonesia', 'Philippines', 'Thailand', 'Malaysia', 'Fiji'], correctIndex: 0 },
    { id: 'H34', category: 'Geography', question: 'What is the capital of South Korea?', answers: ['Seoul', 'Busan', 'Pyongyang', 'Tokyo', 'Incheon', 'Daegu'], correctIndex: 0 },
    { id: 'H35', category: 'Literature', question: 'Who wrote "To Kill a Mockingbird"?', answers: ['Harper Lee', 'Mark Twain', 'John Steinbeck', 'Ernest Hemingway', 'F. Scott Fitzgerald', 'William Faulkner'], correctIndex: 0 },
    { id: 'H36', category: 'Literature', question: 'Who wrote "The Odyssey"?', answers: ['Homer', 'Virgil', 'Sophocles', 'Aristotle', 'Plato', 'Herodotus'], correctIndex: 0 },
    { id: 'H37', category: 'Literature', question: 'What dystopian novel features the character Winston Smith?', answers: ['1984', 'Brave New World', 'Fahrenheit 451', 'Handmaids Tale', 'The Road', 'We'], correctIndex: 0 },
    { id: 'H38', category: 'Movies', question: 'What film won Best Picture at the 2023 Academy Awards?', answers: ['Everything Everywhere', 'The Fabelmans', 'Top Gun Maverick', 'Avatar 2', 'The Banshees', 'Elvis'], correctIndex: 0 },
    { id: 'H39', category: 'Movies', question: 'Who directed "Schindlers List"?', answers: ['Steven Spielberg', 'Martin Scorsese', 'Francis Coppola', 'Ridley Scott', 'Oliver Stone', 'Ron Howard'], correctIndex: 0 },
    { id: 'H40', category: 'Movies', question: 'In "The Dark Knight", who played the Joker?', answers: ['Heath Ledger', 'Jack Nicholson', 'Jared Leto', 'Joaquin Phoenix', 'Mark Hamill', 'Cesar Romero'], correctIndex: 0 },
    { id: 'H41', category: 'Music', question: 'What is the best-selling album of all time?', answers: ['Thriller', 'Back in Black', 'Dark Side of Moon', 'Bat Out of Hell', 'Rumours', 'Saturday Night Fever'], correctIndex: 0 },
    { id: 'H42', category: 'Music', question: 'What band was Freddie Mercury the lead singer of?', answers: ['Queen', 'Rolling Stones', 'Led Zeppelin', 'Pink Floyd', 'The Who', 'Deep Purple'], correctIndex: 0 },
    { id: 'H43', category: 'Music', question: 'What music festival takes place in Indio, California?', answers: ['Coachella', 'Lollapalooza', 'Bonnaroo', 'Burning Man', 'Austin City Limits', 'Outside Lands'], correctIndex: 0 },
    { id: 'H44', category: 'Technology', question: 'What company was founded by Bill Gates?', answers: ['Microsoft', 'Apple', 'IBM', 'Dell', 'HP', 'Intel'], correctIndex: 0 },
    { id: 'H45', category: 'Technology', question: 'What was the first widely-used web browser?', answers: ['Netscape', 'Internet Explorer', 'Firefox', 'Chrome', 'Mosaic', 'Safari'], correctIndex: 0 },
    { id: 'H46', category: 'Technology', question: 'What does CPU stand for?', answers: ['Central Processing Unit', 'Computer Personal Unit', 'Central Power Unit', 'Computing Process Unit', 'Core Processing Unit', 'Central Program Unit'], correctIndex: 0 },
    { id: 'H47', category: 'Art', question: 'Who sculpted the statue of David?', answers: ['Michelangelo', 'Donatello', 'Bernini', 'Rodin', 'Cellini', 'Verrocchio'], correctIndex: 0 },
    { id: 'H48', category: 'Art', question: 'What art movement was Claude Monet associated with?', answers: ['Impressionism', 'Cubism', 'Surrealism', 'Baroque', 'Realism', 'Romanticism'], correctIndex: 0 },
    { id: 'H49', category: 'Sports', question: 'What tennis player has won the most Grand Slam titles (men)?', answers: ['Novak Djokovic', 'Roger Federer', 'Rafael Nadal', 'Pete Sampras', 'Andy Murray', 'Boris Becker'], correctIndex: 0 },
    { id: 'H50', category: 'Sports', question: 'What country has won the most Olympic gold medals in history?', answers: ['United States', 'Russia', 'China', 'Germany', 'Great Britain', 'France'], correctIndex: 0 }
  ],
  'very-hard': [
    ...
    { id: 'VH21', category: 'History', question: 'What event started World War I?', answers: ['Franz Ferdinand assassination', 'Invasion of Poland', 'Pearl Harbor', 'Lusitania sinking', 'Treaty violation', 'Moroccan Crisis'], correctIndex: 0 },
    { id: 'VH22', category: 'History', question: 'Who was the British PM during most of WWII?', answers: ['Winston Churchill', 'Neville Chamberlain', 'Clement Attlee', 'Anthony Eden', 'Harold Macmillan', 'Stanley Baldwin'], correctIndex: 0 },
    { id: 'VH23', category: 'History', question: 'The French Revolution began in which year?', answers: ['1789', '1776', '1799', '1804', '1792', '1785'], correctIndex: 0 },
    { id: 'VH24', category: 'History', question: 'What was the first artificial satellite launched into space?', answers: ['Sputnik 1', 'Explorer 1', 'Vanguard 1', 'Luna 1', 'Telstar 1', 'Kosmos 1'], correctIndex: 0 },
    { id: 'VH25', category: 'Science', question: 'What is the study of earthquakes called?', answers: ['Seismology', 'Geology', 'Volcanology', 'Tectonics', 'Geophysics', 'Petrology'], correctIndex: 0 },
    { id: 'VH26', category: 'Science', question: 'What is the chemical symbol for lead?', answers: ['Pb', 'Ld', 'Le', 'Pl', 'Pd', 'Pt'], correctIndex: 0 },
    { id: 'VH27', category: 'Science', question: 'What is the name of the boundary around a black hole?', answers: ['Event horizon', 'Singularity', 'Photon sphere', 'Accretion disk', 'Schwarzschild radius', 'Ergosphere'], correctIndex: 0 },
    { id: 'VH28', category: 'Science', question: 'What is the most common element in the universe?', answers: ['Hydrogen', 'Helium', 'Oxygen', 'Carbon', 'Nitrogen', 'Iron'], correctIndex: 0 },
    { id: 'VH29', category: 'Geography', question: 'What is the capital of Canada?', answers: ['Ottawa', 'Toronto', 'Vancouver', 'Montreal', 'Calgary', 'Quebec City'], correctIndex: 0 },
    { id: 'VH30', category: 'Geography', question: 'What is the largest island in the world?', answers: ['Greenland', 'Madagascar', 'Borneo', 'New Guinea', 'Sumatra', 'Baffin Island'], correctIndex: 0 },
    { id: 'VH31', category: 'Geography', question: 'Through which city does the Prime Meridian pass?', answers: ['London', 'Paris', 'Berlin', 'Madrid', 'Rome', 'Brussels'], correctIndex: 0 },
    { id: 'VH32', category: 'Geography', question: 'Which river is the longest in Europe?', answers: ['Volga', 'Danube', 'Rhine', 'Seine', 'Elbe', 'Dnieper'], correctIndex: 0 },
    { id: 'VH33', category: 'Literature', question: 'Who wrote "Pride and Prejudice"?', answers: ['Jane Austen', 'Charlotte Bronte', 'Emily Bronte', 'Mary Shelley', 'George Eliot', 'Virginia Woolf'], correctIndex: 0 },
    { id: 'VH34', category: 'Literature', question: 'Who wrote "The Great Gatsby"?', answers: ['F. Scott Fitzgerald', 'Ernest Hemingway', 'John Steinbeck', 'William Faulkner', 'Sinclair Lewis', 'Theodore Dreiser'], correctIndex: 0 },
    { id: 'VH35', category: 'Literature', question: 'Who wrote "Crime and Punishment"?', answers: ['Fyodor Dostoevsky', 'Leo Tolstoy', 'Anton Chekhov', 'Ivan Turgenev', 'Nikolai Gogol', 'Boris Pasternak'], correctIndex: 0 },
    { id: 'VH36', category: 'Movies', question: 'Who directed "Pulp Fiction"?', answers: ['Quentin Tarantino', 'Martin Scorsese', 'Steven Spielberg', 'Christopher Nolan', 'David Fincher', 'Coen Brothers'], correctIndex: 0 },
    { id: 'VH37', category: 'Movies', question: 'In "Inception", what determines if one is in a dream?', answers: ['Spinning top', 'Watch', 'Coin', 'Dice', 'Chess piece', 'Poker chip'], correctIndex: 0 },
    { id: 'VH38', category: 'Movies', question: 'What year was the original "Star Wars" released?', answers: ['1977', '1979', '1975', '1980', '1976', '1978'], correctIndex: 0 },
    { id: 'VH39', category: 'Music', question: 'What classical composer became deaf later in life?', answers: ['Beethoven', 'Mozart', 'Bach', 'Chopin', 'Brahms', 'Handel'], correctIndex: 0 },
    { id: 'VH40', category: 'Music', question: 'What is the highest female singing voice?', answers: ['Soprano', 'Alto', 'Mezzo-soprano', 'Contralto', 'Coloratura', 'Lyric'], correctIndex: 0 },
    { id: 'VH41', category: 'Music', question: 'Which artist released the album "Thriller"?', answers: ['Michael Jackson', 'Prince', 'Whitney Houston', 'Madonna', 'Lionel Richie', 'Stevie Wonder'], correctIndex: 0 },
    { id: 'VH42', category: 'Art', question: 'Who painted "The Birth of Venus"?', answers: ['Sandro Botticelli', 'Leonardo da Vinci', 'Raphael', 'Titian', 'Michelangelo', 'Caravaggio'], correctIndex: 0 },
    { id: 'VH43', category: 'Art', question: 'What is the name of the effect where light bends around massive objects?', answers: ['Gravitational lensing', 'Doppler effect', 'Redshift', 'Parallax', 'Chromatic aberration', 'Diffraction'], correctIndex: 0 },
    { id: 'VH44', category: 'Sports', question: 'How long is an Olympic swimming pool in meters?', answers: ['50 meters', '25 meters', '100 meters', '75 meters', '40 meters', '60 meters'], correctIndex: 0 },
    { id: 'VH45', category: 'Sports', question: 'What country has won the most FIFA World Cup titles?', answers: ['Brazil', 'Germany', 'Italy', 'Argentina', 'France', 'Uruguay'], correctIndex: 0 },
    { id: 'VH46', category: 'Technology', question: 'Who is credited with inventing the World Wide Web?', answers: ['Tim Berners-Lee', 'Vint Cerf', 'Robert Kahn', 'Marc Andreessen', 'Bill Gates', 'Steve Jobs'], correctIndex: 0 },
    { id: 'VH47', category: 'Technology', question: 'What does RAM stand for in computing?', answers: ['Random Access Memory', 'Read Access Memory', 'Rapid Access Memory', 'Runtime Access Memory', 'Real Access Memory', 'Remote Access Memory'], correctIndex: 0 },
    { id: 'VH48', category: 'Technology', question: 'What programming language was created by Guido van Rossum?', answers: ['Python', 'Java', 'Ruby', 'C++', 'JavaScript', 'Go'], correctIndex: 0 },
    { id: 'VH49', category: 'Science', question: 'What blood type is considered the universal donor?', answers: ['O negative', 'AB positive', 'A positive', 'B negative', 'O positive', 'AB negative'], correctIndex: 0 },
    { id: 'VH50', category: 'Science', question: 'What is the study of fungi called?', answers: ['Mycology', 'Biology', 'Botany', 'Zoology', 'Microbiology', 'Ecology'], correctIndex: 0 }
  ],
  'genius': [
    ...
    { id: 'G21', category: 'Science', question: 'What subatomic particles make up a proton?', answers: ['Two up quarks and one down', 'Two down quarks and one up', 'Three up quarks', 'Three down quarks', 'One up and two strange', 'Three charm quarks'], correctIndex: 0 },
    { id: 'G22', category: 'Science', question: 'What enzyme unwinds DNA during replication?', answers: ['Helicase', 'Polymerase', 'Ligase', 'Primase', 'Topoisomerase', 'Gyrase'], correctIndex: 0 },
    { id: 'G23', category: 'Science', question: 'What is the approximate age of the universe?', answers: ['13.8 billion years', '10.5 billion years', '15.2 billion years', '18 billion years', '12.4 billion years', '20 billion years'], correctIndex: 0 },
    { id: 'G24', category: 'History', question: 'What empire was ruled by Suleiman the Magnificent?', answers: ['Ottoman Empire', 'Byzantine Empire', 'Mongol Empire', 'Persian Empire', 'Mughal Empire', 'Holy Roman Empire'], correctIndex: 0 },
    { id: 'G25', category: 'History', question: 'What was the primary cause of the Peloponnesian War?', answers: ['Athens and Sparta rivalry', 'Persian invasion', 'Trade disputes', 'Religious differences', 'Colonial expansion', 'Succession crisis'], correctIndex: 0 },
    { id: 'G26', category: 'History', question: 'Who was the first Holy Roman Emperor?', answers: ['Charlemagne', 'Otto I', 'Frederick Barbarossa', 'Charles V', 'Henry IV', 'Louis the Pious'], correctIndex: 0 },
    { id: 'G27', category: 'Philosophy', question: 'Who wrote "Thus Spoke Zarathustra"?', answers: ['Friedrich Nietzsche', 'Immanuel Kant', 'Georg Hegel', 'Arthur Schopenhauer', 'Soren Kierkegaard', 'Edmund Husserl'], correctIndex: 0 },
    { id: 'G28', category: 'Philosophy', question: 'What is the philosophical study of knowledge called?', answers: ['Epistemology', 'Ontology', 'Ethics', 'Aesthetics', 'Metaphysics', 'Logic'], correctIndex: 0 },
    { id: 'G29', category: 'Philosophy', question: 'Who wrote "Being and Nothingness"?', answers: ['Jean-Paul Sartre', 'Martin Heidegger', 'Albert Camus', 'Simone de Beauvoir', 'Maurice Merleau-Ponty', 'Emmanuel Levinas'], correctIndex: 0 },
    { id: 'G30', category: 'Literature', question: 'Who wrote "In Search of Lost Time"?', answers: ['Marcel Proust', 'James Joyce', 'Virginia Woolf', 'Franz Kafka', 'Thomas Mann', 'Robert Musil'], correctIndex: 0 },
    { id: 'G31', category: 'Literature', question: 'What is the longest epic poem in history?', answers: ['Mahabharata', 'Iliad', 'Odyssey', 'Beowulf', 'Ramayana', 'Divine Comedy'], correctIndex: 0 },
    { id: 'G32', category: 'Literature', question: 'Who wrote "One Hundred Years of Solitude"?', answers: ['Gabriel Garcia Marquez', 'Jorge Luis Borges', 'Pablo Neruda', 'Isabel Allende', 'Mario Vargas Llosa', 'Julio Cortazar'], correctIndex: 0 },
    { id: 'G33', category: 'Art', question: 'What artistic technique uses small dots of color?', answers: ['Pointillism', 'Impressionism', 'Cubism', 'Fauvism', 'Expressionism', 'Divisionism'], correctIndex: 0 },
    { id: 'G34', category: 'Art', question: 'Who founded the Bauhaus school?', answers: ['Walter Gropius', 'Ludwig Mies van der Rohe', 'Le Corbusier', 'Frank Lloyd Wright', 'Marcel Breuer', 'Hannes Meyer'], correctIndex: 0 },
    { id: 'G35', category: 'Art', question: 'Who painted "The Garden of Earthly Delights"?', answers: ['Hieronymus Bosch', 'Jan van Eyck', 'Pieter Bruegel', 'Albrecht Durer', 'Rogier van der Weyden', 'Hans Memling'], correctIndex: 0 },
    { id: 'G36', category: 'Music', question: 'What is the lowest female singing voice?', answers: ['Contralto', 'Alto', 'Mezzo-soprano', 'Soprano', 'Bass', 'Baritone'], correctIndex: 0 },
    { id: 'G37', category: 'Music', question: 'Which composer wrote "The Rite of Spring"?', answers: ['Igor Stravinsky', 'Sergei Prokofiev', 'Dmitri Shostakovich', 'Pyotr Tchaikovsky', 'Sergei Rachmaninoff', 'Alexander Scriabin'], correctIndex: 0 },
    { id: 'G38', category: 'Music', question: 'What is the Italian term for playing music very softly?', answers: ['Pianissimo', 'Fortissimo', 'Mezzo-forte', 'Sforzando', 'Crescendo', 'Diminuendo'], correctIndex: 0 },
    { id: 'G39', category: 'Math', question: 'What is the derivative of e^x?', answers: ['e^x', 'x*e^(x-1)', 'ln(x)', '1/x', 'x*e^x', 'e^(x-1)'], correctIndex: 0 },
    { id: 'G40', category: 'Math', question: 'What mathematical concept did Galois contribute to?', answers: ['Group theory', 'Calculus', 'Set theory', 'Topology', 'Number theory', 'Graph theory'], correctIndex: 0 },
    { id: 'G41', category: 'Economics', question: 'Who wrote "The Wealth of Nations"?', answers: ['Adam Smith', 'John Maynard Keynes', 'Karl Marx', 'Milton Friedman', 'David Ricardo', 'Thomas Malthus'], correctIndex: 0 },
    { id: 'G42', category: 'Economics', question: 'What is the term for a market with a single seller?', answers: ['Monopoly', 'Oligopoly', 'Monopsony', 'Perfect competition', 'Duopoly', 'Cartel'], correctIndex: 0 },
    { id: 'G43', category: 'Geography', question: 'What is the driest place on Earth?', answers: ['Atacama Desert', 'Sahara Desert', 'Antarctica', 'Death Valley', 'Gobi Desert', 'Namib Desert'], correctIndex: 0 },
    { id: 'G44', category: 'Geography', question: 'What two countries share the longest international border?', answers: ['Canada and USA', 'Russia and China', 'Argentina and Chile', 'India and Bangladesh', 'Russia and Kazakhstan', 'China and Mongolia'], correctIndex: 0 },
    { id: 'G45', category: 'Science', question: 'What is the Fermi Paradox primarily concerned with?', answers: ['Absence of alien civilizations', 'Universe expansion', 'Dark matter', 'Speed of light limit', 'Black holes', 'Quantum entanglement'], correctIndex: 0 },
    { id: 'G46', category: 'Science', question: 'What is the Riemann Hypothesis concerned with?', answers: ['Distribution of prime numbers', 'Fermats theorem', 'Goldbach conjecture', 'Twin primes', 'Perfect numbers', 'Mersenne primes'], correctIndex: 0 },
    { id: 'G47', category: 'History', question: 'What was the capital of the Byzantine Empire?', answers: ['Constantinople', 'Rome', 'Athens', 'Alexandria', 'Antioch', 'Jerusalem'], correctIndex: 0 },
    { id: 'G48', category: 'History', question: 'The Hundred Years War was fought between which countries?', answers: ['England and France', 'England and Spain', 'France and Germany', 'Spain and Portugal', 'England and Scotland', 'France and Italy'], correctIndex: 0 },
    { id: 'G49', category: 'History', question: 'What ancient civilization created the first known writing system?', answers: ['Sumerians', 'Egyptians', 'Chinese', 'Greeks', 'Phoenicians', 'Babylonians'], correctIndex: 0 },
    { id: 'G50', category: 'Philosophy', question: 'What is "tabula rasa"?', answers: ['Blank slate theory of mind', 'Categorical imperative', 'Social contract', 'Existential dread', 'Cogito ergo sum', 'Will to power'], correctIndex: 0 }
  ]
};
